 ...
 * 夺宝纪录 － 等待揭晓（dev）
 */
public class DuoBaoWaitFragment extends BaseFragment {
    ...
    private void testStatices() {
        ...
        ShiNcAgent.onEvent(getActivity(), "ad_click" +
                "", params);
    }
    ...
    private void initModel() {
        ...
        page = 1;
        recrodModel.getDuoBaoRecrod("1", page);
    }
    ...
    public void onEventMainThread(DuoBaoWaitFragmentEvent recrodEvent) {
