...
public class DuoBaoRecordAdapter extends BaseAdapter {
    ...
    private List<DuoBaoRecordsBean.DuoBaoReCrodChildBean> crodChildBeans;
    ...
    public DuoBaoRecordAdapter(Activity mActivity) {
    ...
    public List<DuoBaoRecordsBean.DuoBaoReCrodChildBean> getCrodChildBeans() {
        return crodChildBeans;
    }

    public void setCrodChildBeans(List<DuoBaoRecordsBean.DuoBaoReCrodChildBean> crodChildBeans) {
    ...
    public int getItemViewType(int position) {
        ...
        if (getCrodChildBeans().get(position).getWinning_user() == null) {
            return TYPE_1;
        } else {
            return TYPE_2;
        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case TYPE_1:
                ...
                duoBaoRecordViewHolder1.layouCutNum.setText("剩余:" + getCrodChildBeans().get(position).getRemainder());
                duoBaoRecordViewHolder1.layouTotalNum.setText("共需: " + getCrodChildBeans().get(position).getReal_need_times());
                duoBaoRecordViewHolder1.progressBar.setProgress(Integer.parseInt(getCrodChildBeans().get(position).getRate()));
                duoBaoRecordViewHolder1.addMai.setText("追加");

                if (Integer.parseInt(getCrodChildBeans().get(position).getRate()) == 100) {
                    ...
                    duoBaoRecordViewHolder1.addMai.setBackgroundResource(R.drawable.red_btn_selector);
                ...
                duoBaoRecordViewHolder1.searchDetail.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("user_id", spUtils.get(Constant.SP_USER_ID, ""));
                        ...
                        intent.putExtra("sh_activity_period_id", getCrodChildBeans().get(position).getSh_activity_period_id());
                ...
                duoBaoRecordViewHolder1.imgUrl.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("PRODUCTID", getCrodChildBeans().get(position).getSh_activity_period_id());
                        mActivity.startActivity(intent);
                    }
                });
                ...
                break;
            case TYPE_2:
                if (TextUtils.isEmpty(getCrodChildBeans().get(position).getGoods_img().trim())) {
                    duoBaoRecordViewHolder2.imgUrl.setImageResource(R.drawable.icon_nopic);
                } else {
//                    ImageLoad.getInstance(mActivity).setImageToView(getCrodChildBeans().get(position).getGoods_img() + Constant.QINIU270_270, duoBaoRecordViewHolder2.imgUrl);
                ...
                duoBaoRecordViewHolder2.winneNumr.setText(getCrodChildBeans().get(position).getWinning_user().getNick_name());
                duoBaoRecordViewHolder2.periodInM.setText(getCrodChildBeans().get(position).getWinning_user().getTimes());
                duoBaoRecordViewHolder2.lunckyNumber.setText(getCrodChildBeans().get(position).getWinning_user().getLuck_code());
                duoBaoRecordViewHolder2.outOfTime.setText(getCrodChildBeans().get(position).getWinning_user().getLuck_code_create_time());
