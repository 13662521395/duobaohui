...
public class LocalImageHelper {
    ...
    public String getCameraImgPath() {
        Log.e("CamerIngaPath", CameraImgPath);
            ...
            if (file.exists()) {
                ...
                if (LocalImageHelper.getInstance().getCheckedItems() != null && LocalImageHelper.getInstance().getCheckedItems().size() > 0) {
                    for (int i = 0; i < LocalImageHelper.getInstance().getCheckedItems().size(); i++) {
                        if (LocalImageHelper.getInstance().getCheckedItems().get(i).getOriginalUri().equals(localFile.getOriginalUri())) {
                            isHave = true;
                        }
                    }
                }
