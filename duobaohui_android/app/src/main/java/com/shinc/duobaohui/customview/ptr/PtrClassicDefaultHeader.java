...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private ImageView iconRotateView;
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        iconRotateView = (ImageView) header.findViewById(R.id.ptr_classic_header_tween_animal);
        iconRotateView.setImageResource(R.drawable.loading_anim);
        animationDrawable = (AnimationDrawable) iconRotateView.getDrawable();
    ...
    private void resetView() {
        hideRotateView();
        iconRotateView.setVisibility(INVISIBLE);
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        hideRotateView();
        iconRotateView.setVisibility(VISIBLE);
