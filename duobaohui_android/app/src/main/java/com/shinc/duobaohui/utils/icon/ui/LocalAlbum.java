...
import com.shinc.duobaohui.utils.icon.StringUtils;
...
public class LocalAlbum extends BaseActivity {
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if (LocalImageHelper.getInstance().getCurrentSize() + LocalImageHelper.getInstance().getCheckedItems().size() >= MyApplication.ImageViewNum) {
                ...
                case ImageUtils.REQUEST_CODE_GETIMAGE_BYCAMERA:
                    ...
                    if (file.exists()) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                setResult(ImageUtils.REQUEST_CODE_GETIMAGE_BYCROP);
                                finish();
                            }
                        }, 1000);
                    } else {
