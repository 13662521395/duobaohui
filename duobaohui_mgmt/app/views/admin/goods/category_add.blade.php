		...
		<div class="col-lg-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					@endif
					<form class='form-horizontal tasi-form' method='post' action='/admin/goods/category-add' >
						@if (isset($parent))
							<div class='form-group'>
								<label class='col-sm-2 control-label'>父类名称</label>
								<div class="col-sm-10">
									<span>{{$parent->cat_name}}</span>
						...
						<div class='form-group'>
							...
							<div class="col-sm-10">
								<textarea name="description" class="col-sm-10"></textarea>
							</div>
						</div>
						<div>
