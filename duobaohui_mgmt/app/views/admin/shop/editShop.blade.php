            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="clearfix" style="margin-top:20px">
                        <a href="/admin/shop/shop-list" class="btn btn-danger pull-right"><i class="icon-remove"></i>&nbsp;取消</a>
                        <button class="btn btn-success pull-right" id="shop_edit_btn" style="margin-right:10px"><i class="icon-ok"></i>&nbsp;提交</button>
                    </div>
                </div>
            </section>
        </div>
