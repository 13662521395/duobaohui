...
<html lang="en">
  <head>
    ...
    {{ HTML::style('/flatlib/assets/data-tables/DT_bootstrap.css') }}
...
<!-- 	{{ HTML::style('/flatlib/assets/bootstrap-datepicker/css/datepicker.css') }}
    {{ HTML::style('/flatlib/assets/bootstrap-timepicker/compiled/timepicker.css') }}
    {{ HTML::style('/flatlib/assets/bootstrap-colorpicker/css/colorpicker.css') }} -->
    {{ HTML::style('/flatlib/assets/bootstrap-daterangepicker/daterangepicker-bs3.css') }}
    {{ HTML::style('/flatlib/assets/bootstrap-datetimepicker/css/datetimepicker.css') }}


    {{ HTML::script('/flatlib/js/jquery-1.8.3.min.js') }}
<!--     {{ HTML::script('/flatlib/js/bootstrap.min.js') }}
    {{ HTML::script('/flatlib/assets/advanced-datatable/media/js/jquery.dataTables.js') }} -->
  ...
  <section id="container" >
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="/admin/index" class="logo"><span>夺宝会后台管理系统</span></a>
            <!--logo end-->
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="/admin/user/logout"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
