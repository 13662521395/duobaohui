...
********************/
frm.define('component/dialog',['jquery'],function(require , exports){
    var $ = require('jquery');
	return {
		meiliDialog : function(options){
			...
			//dialog
			var dialog = function(){
				var dialogLayer = $('<div style="overflow:auto;width:'+ opts.dialogWidth +'px" id="'+ opts.dialogId +'" ><div style="width:'+ (opts.dialogWidth) +'px" id="dialogTitle"><span id="closeDialog" class="close_z">X</span><span id="dialogTitleText">'+ opts.dialogTitle +'</span></div><div style="width:'+ (opts.dialogWidth) +'px" id="dialogContent" ></div></div>');
			...
			var toFixed = function(){
				if(opts.isOverflow){
					...
					if(isIE){
						...
						$("#"+opts.dialogId).css({"position":"absolute"})
					}
				}
			}
