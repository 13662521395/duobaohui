...
?><style type="text/css">
	.model{
		...
		padding:10px;
			...
			您正在删除<p class="name"></p><div class="alert alert-danger" style="display:none"><span></span></div><button class="btn btn-danger" type="button" ><i class="icon-remove bigger-110"></i>
					取消
				</button>&nbsp;
