			...
			<div class='col-lg-12'>
				<section class="panel" id='tip'>
					...
					<div class='panel-body'>
						...
						@endif
						<form class='form-horizontal tasi-form' method='post' action='/admin/authority/save-edit-authority' >
							<input type='hidden' value="{{ $info->id }}" name="authority_id" />
							...
							<div class='form-group'>
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="notes" value="{{ $info->url_notes}}"/>
								</div>
							</div>
							<div class='form-group'>
