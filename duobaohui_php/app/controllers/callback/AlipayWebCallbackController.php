...
use App\Libraries\alipayWebConfig;//引入支付宝移动支付异步服务器配置文件

class  AlipayWebCallbackController extends  ApiController {
		...
		if($verify_result) {//验证成功
			...
			try {
				...
				if ($trade_status == 'TRADE_FINISHED' || $trade_status == 'TRADE_SUCCESS') {
					...
					if (empty($alipayInfo)) {
						$this->jnlAlipayModel->addInfo($data);
						$flag = true;
					} else {
