                ...
                try {
                    if ($flag) {
                        ...
                        if ($id) {
                            ...
                            if ($this->jnlService->payCallbackUpdateJnl($out_trade_no, $pay_amount, $id, JnlService::JnlTrans_Status_pay_success,JnlService::Recharge_Channel_weixin,$redpacket)) {
