...
class OutputFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testStyleMatchingNotGreedy()
    {
        ...
        $this->assertEquals(
            "(\033[32m>=version_2,<2.3\033[39m)",
            $formatter->format('(<info>>=version_2,<2.3</info>)')
        );
    }
    ...
    public function testStyleEscaping()
    {
        ...
        $this->assertEquals(
            "(\033[32mz>=version_2,<a2.3\033[39m)",
            $formatter->format('(<info>'.$formatter->escape('z>=version_2,<a2.3').'</info>)')
        );
    }
