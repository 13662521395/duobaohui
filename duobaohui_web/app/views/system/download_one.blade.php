    	...
    	<div id="master">
    		<div class="browser_master"></div>
	 	  	<div class="dbh_panel">
	    		...
	    		<p>
					...
					<input type="hidden" id="tel" value="{{ $tel or 'null' }}" />
					<input id="shopId" type="hidden" value="{{ $shopId or '-1' }}"/>
					<input id="shopChannelId" type="hidden" value="{{ $shopChannelId or '0' }}"/>
   		...
   		<script type="text/javascript">
   			$(document).ready(function(){
				...
				var shopChannelId = $('#shopChannelId').val();
				var scene = $('#scene').val();
...
//   							alert("iPhone客户端正在研发中...敬请期待！");
							window.location.href = "https://itunes.apple.com/cn/app/duo-bao-hui/id1061035639?mt=8"
   						}else{
